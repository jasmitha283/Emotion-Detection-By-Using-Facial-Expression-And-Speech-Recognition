...
def graph():
    ...
    plt.ylabel('Accuracy')
    plt.plot(fa, 'ro-', color = 'yellow')
    plt.plot(fl, 'ro-', color = 'red')
...
title.config(bg='yellow', fg='medium orchid')  
title.config(font=font)           
title.config(height=3, width=175)       
title.place(x=0,y=5)
...
predictspeechButton.place(x=250,y=540)
predictspeechButton.config(font=font1)

exitButton = Button(main, text="Exit", command=exit)
exitButton.place(x=250,y=590)
